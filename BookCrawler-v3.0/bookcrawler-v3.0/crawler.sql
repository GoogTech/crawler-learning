...
--
-- Table structure for table `jd_book`
--

DROP TABLE IF EXISTS `jd_book`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `jd_book` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shCode` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2019-07-18 11:11:17
